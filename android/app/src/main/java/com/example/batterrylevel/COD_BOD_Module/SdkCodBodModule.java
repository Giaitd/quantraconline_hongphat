...
public class SdkCodBodModule {
    ...
    public CodBodData getCodBodData() {
        try {
            ...
            double tssData;
            //cod
            byte[] bufferCod = new byte[]{1, 3, 38, 0, 0, 4, 79, 65}; // {01 03 26 00 00 04 4F 41}
            ...
            //bod
            byte[] bufferBod = new byte[]{1, 3, 38, 4, 0, 2, -114, -126}; // {01 03 26 04 00 02 8E 82}
            ...
            //tss
            byte[] bufferTss = new byte[]{1, 3, 18, 0, 0, 2, -63, 115}; // {01 03 12 00 00 02 C1 73}
            ...
            // đọc giá trị COD
            if (checkReadCod.equals("010308") && checkReadBod.equals("010304") && checkReadTss.equals("010318")) {
                ...
                Integer exponentCod = Integer.parseInt(dataReceiveCod1, 2) - 127;
                ...
                Integer exponentBod = Integer.parseInt(dataReceiveBod1, 2) - 127;
                ...
                Integer exponentTss = Integer.parseInt(dataReceiveTss1, 2) - 127;
